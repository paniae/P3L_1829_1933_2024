...
<div class="main">
    <div class="card">
        ...
        <div class="fw-bold mt-3 mb-2">LAPORAN Stok Gudang</div>
        ...
        <div class="table-responsive mt-3 mb-3">
            <table class="table table-bordered align-middle">
                ...
                @empty
                    <tr><td colspan="9" class="text-center">Tidak ada stok barang hari ini.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
        <a href="{{ route('stokgudang.pdf') }}"
           target="_blank" class="btn btn-pdf fw-bold" style="padding: 9px 28px; font-size: 16px;">
            <i class="bi bi-printer"></i> Cetak PDF Laporan Stok Gudang
        </a>
    </div>
</div>
